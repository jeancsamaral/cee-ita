...
const graphic_1 = (
  ...
  >
    <g opacity="0.7">
      ...
      <path
        opacity="0.45"
        d="M193.684 157.117C121.962 95.9418 -39.8641 -27.2144 -113.396 -30.4354C-205.311 -34.4616 -157.651 103.037 -198.958 144.887C-240.264 186.737 -281.901 225.784 -256.326 300.424C-242.723 340.126 -208.834 450.117 21.2627 453.541"
        stroke="url(#paint3_linear_1025_537)"
      />
      <path
        opacity="0.45"
        d="M197.239 170.241C125.518 109.066 -36.3089 -14.0904 -109.841 -17.3114C-201.756 -21.3376 -154.096 116.161 -195.402 158.011C-236.709 199.861 -278.346 238.908 -252.771 313.548C-239.167 353.25 -205.279 463.241 24.8181 466.665"
...
const BrandsStyleTwo = () => {
  return (
    <section>
      <div className="container">
        <div className="relative z-10 overflow-hidden rounded bg-gradient-to-t from-transparent to-[#F0F2F9] dark:to-gray-dark">
          <div className="px-3 pb-14 pt-[65px] xl:px-5">
          ...
          <div className="flex flex-wrap items-center justify-between px-8 pb-[70px] pt-[45px] sm:px-10 md:px-14 lg:flex-nowrap lg:px-14 xl:px-[100px]">
            <div className="mb-10 lg:mb-0 lg:max-w-[500px]">
              <h2 className="text-center text-[28px] font-semibold leading-snug text-black dark:text-white sm:text-[32px] lg:text-left">
                Conectando talentos do ITA às melhores oportunidades desde 2014
              </h2>
            </div>
